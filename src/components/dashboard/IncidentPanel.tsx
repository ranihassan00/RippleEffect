...
export function IncidentPanel() {
  ...
  return <Panel className="rail-panel incident-panel">
    ...
    <div className="panel-section">
      ...
      <label className="field-label">Operational note<textarea aria-label="Operational note" rows={2} maxLength={240} value={scenario.incident.description} onChange={(event) => setScenarioField("incident.description", event.target.value)} /></label>
    </div>
